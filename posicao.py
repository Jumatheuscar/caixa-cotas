...
<style>
    ...
    .stDataFrame, .st-emotion-cache-1djdyxw {{
        width: 100% !important;
...
if aba == "📊 Enquadramento":
    ...
    pl_apuama = df_dre.iloc[-1]["PL TOTAL"]
    ...
    if uploaded_file:
        ...
        # Mostrar indicadores estilizados
